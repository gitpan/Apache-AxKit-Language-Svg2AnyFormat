# This Makefile is for the Apache::AxKit::Language::Svg2AnyFormat extension to perl.
#
...
#     AUTHOR => q[Tom Schindl <tom.schindl@bestsolution.at>]
#     NAME => q[Apache::AxKit::Language::Svg2AnyFormat]
#     PREREQ_PM => { Image::Magick=>q[5.55], AxKit=>q[1.6.1] }
#     VERSION_FROM => q[lib/Apache/AxKit/Language/Svg2AnyFormat.pm]
...
DISTNAME = Apache-AxKit-Language-Svg2AnyFormat
NAME_SYM = Apache_AxKit_Language_Svg2AnyFormat
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
...
FULLEXT = Apache/AxKit/Language/Svg2AnyFormat
BASEEXT = Svg2AnyFormat
PARENT_NAME = Apache::AxKit::Language
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Apache/AxKit/Language/Svg2AnyFormat.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Apache/AxKit/Language/Svg2AnyFormat.pm \
	lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Apache/AxKit/Language
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Apache/AxKit/Language
...
TO_INST_PM = lib/Apache/AxKit/Language/Svg2AnyFormat.pm \
	lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm

PM_TO_BLIB = lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm \
	blib/lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm \
	lib/Apache/AxKit/Language/Svg2AnyFormat.pm \
	blib/lib/Apache/AxKit/Language/Svg2AnyFormat.pm
...
manifypods : pure_all lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm \
	lib/Apache/AxKit/Language/Svg2AnyFormat.pm
	@$(POD2MAN) \
	lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm \
	$(INST_MAN3DIR)/Apache::AxKit::Plugin::SvgCgiSerialize.$(MAN3EXT) \
	lib/Apache/AxKit/Language/Svg2AnyFormat.pm \
	$(INST_MAN3DIR)/Apache::AxKit::Language::Svg2AnyFormat.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm
	rm -f blib/lib/Apache/AxKit/Language/Svg2AnyFormat.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,01,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR>Tom Schindl &lt;tom.schindl\@bestsolution.at&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"AxKit\" VERSION=\"1,6,1,0\" />\n\t\t<DEPENDENCY NAME=\"Image-Magick\" VERSION=\"5,55,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/Apache/AxKit/Language/Svg2AnyFormat.pm blib/lib/Apache/AxKit/Language/Svg2AnyFormat.pm lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm blib/lib/Apache/AxKit/Plugin/SvgCgiSerialize.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
